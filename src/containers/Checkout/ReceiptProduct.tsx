        ...
        <Grid borderBottom={`1px solid ${theme.colors.background}`} gridTemplateRows="30px 30px 30px" height="90px">
            <Grid gridTemplateColumns="1fr 1fr">
                ...
                <Flex justifySelf="end">
                    <Text fontWeight={600} fontSize={14}>{ `${price?.currency} ${price?.pricePerUnit ? price?.pricePerUnit * quantity : price?.pricePerUnit}`}</Text>
                </Flex>
            </Grid>
            <Grid gridTemplateColumns="1fr 1fr">
                <Flex>
                ...
                <Flex justifySelf="end">
                    <Text fontWeight={500} fontSize={12}>{`R ${deliveryFee}`}</Text>
                </Flex>
            </Grid>
            <Grid gridTemplateColumns={mobileFlow ? "1fr 150px" : "1fr 1fr"}>
                <Flex>
                    <Text fontSize={14}>Trade Finance Margin (10%)</Text>
                </Flex>
                <Flex justifySelf="end">
                    <Text fontWeight={500} fontSize={12}>{`R ${tradeFinanceMargin}`}</Text>
                </Flex>
            </Grid>
        </Grid>
    );
