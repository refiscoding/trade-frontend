...
const CardsContainer: React.FC<CardsContainerProps> = ({ children, mobileFlow, ...rest }) => {
    ...
    return(
        <Grid mt={marginTop} rowGap={rowGap} gridTemplateColumns={numberOfColumns} height={height}  overflowY={overflowY}  columnGap="10px" gridTemplateRows="auto auto auto" width="100%" {...rest} >
            { children }
        </Grid>
    );
};
